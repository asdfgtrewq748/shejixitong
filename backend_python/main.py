...
from routers import upload, boreholes, design, score, boundary, geology, succession, gnn_geology, disturbance
...
app.include_router(disturbance.router, prefix="/api/disturbance", tags=["Disturbance Evaluation"])
